...
idCVar r_displayRefresh( "r_displayRefresh", "0", CVAR_RENDERER | CVAR_INTEGER | CVAR_NOCHEAT | CVAR_ARCHIVE, "optional display refresh rate option for vid mode", 0.0f, 240.0f );
//#ifdef WIN32
...
idCVar r_useSRGB( "r_useSRGB", "1", CVAR_RENDERER | CVAR_INTEGER | CVAR_ARCHIVE, "1 = both texture and framebuffer, 2 = framebuffer only, 3 = texture only" );
idCVar r_maxAnisotropicFiltering( "r_maxAnisotropicFiltering", "2", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "limit aniso filtering" );
...
idCVar r_skipCopyTexture( "r_skipCopyTexture", "1", CVAR_RENDERER | CVAR_BOOL, "do all rendering, but don't actually copyTexSubImage2D" );
...
idCVar r_useShadowDepthBounds( "r_useShadowDepthBounds", "0", CVAR_RENDERER | CVAR_BOOL, "use depth bounds test on individual shadow volumes to reduce shadow fill" );
// RB begin
...
idCVar r_shadowMapImageSize( "r_shadowMapImageSize", "256", CVAR_RENDERER | CVAR_INTEGER, "", 128, 2048 );
...
idCVar r_shadowMapRandomizeJitter( "r_shadowMapRandomizeJitter", "0", CVAR_RENDERER | CVAR_BOOL, "randomly offset jitter texture each draw" );
idCVar r_shadowMapSamples( "r_shadowMapSamples", "1", CVAR_RENDERER | CVAR_INTEGER, "0, 1, 4, or 16" );
idCVar r_shadowMapSplits( "r_shadowMapSplits", "1", CVAR_RENDERER | CVAR_INTEGER, "number of splits for cascaded shadow mapping with parallel lights", 0, 4 );
...
idCVar r_shadowMapPolygonFactor( "r_shadowMapPolygonFactor", "1.5", CVAR_RENDERER | CVAR_FLOAT, "polygonOffset factor for drawing shadow buffer" );
idCVar r_shadowMapPolygonOffset( "r_shadowMapPolygonOffset", "32", CVAR_RENDERER | CVAR_FLOAT, "polygonOffset units for drawing shadow buffer" );
...
idCVar r_shadowMapRegularDepthBiasScale( "r_shadowMapRegularDepthBiasScale", "0.99971", CVAR_RENDERER | CVAR_FLOAT, "shadowmap bias to fight shadow acne for point and spot lights" );
...
idCVar r_hdrMinLuminance( "r_hdrMinLuminance", "0.03", CVAR_RENDERER | CVAR_FLOAT, "" );
...
idCVar r_useFilmicPostProcessEffects( "r_useFilmicPostProcessEffects", "0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL, "apply several post process effects to mimic a filmic look" );
...
idCVar r_exposure( "r_exposure", "1", CVAR_ARCHIVE | CVAR_RENDERER | CVAR_FLOAT, "HDR exposure or LDR brightness [0.0 .. 1.0]", 0.0f, 1.0f );
// RB end
//GK begin
