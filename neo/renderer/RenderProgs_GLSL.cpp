...
struct precisionMapping_t
{
    const char* name;
    const char* precision;
};

static precisionMapping_t glslPrecisionMap[] =
        {
                ...
                { "vofi_Color",				"mediump" },
                { "vofi_SecondaryColor",	"mediump" },
                { "vofi_TexCoord0",	"highp" },
                { "vofi_TexCoord1",	"highp" },
                { "vofi_TexCoord2",	"highp" },
                { "vofi_TexCoord3",	"highp" },
                { "vofi_TexCoord4",	"highp" },
                { "vofi_TexCoord5",	"highp" },
                { "vofi_TexCoord6",	"highp" },
                { "vofi_TexCoord7",	"highp" },
                { "vofi_TexCoord8",	"highp" },
                { "vofi_TexCoord9",	"highp" },

                { "fo_FragColor",	"mediump" },

                { "gl_FragCoord",	"highp" },
                { "gl_FrontFacing", "mediump" },
                { "gl_FragDepth",	"highp" },
                { NULL, NULL }
        };

static precisionMapping_t samplerPrecisionMap[] =
        {
                { "sampler2D",			"mediump" },
                { "sampler3D",			"mediump" },
                { "samplerCube",		"mediump" },
                { "sampler2DShadow",		"mediump" },
                { "sampler2DArrayShadow",	"mediump" },
                { "sampler2DArray",		"mediump" },
                { "sampler2DMS",		"mediump" },
                { NULL, NULL }
        };

struct uniformPrecision_t
{
    const char* name;
    const char* precision;
};
...
static uniformPrecision_t uniformPrecisions[] =
        {
                { "rpScreenCorrectionFactor",	"mediump" },
                { "rpWindowCoord",			"mediump" },
                { "rpDiffuseModifier",		"mediump" },
                { "rpSpecularModifier",		"mediump" },
                { "rpLocalLightOrigin",		"highp" },
                { "rpLocalViewOrigin",		"highp" },
                { "rpLightProjectionS",		"highp" },
                { "rpLightProjectionT",		"highp" },
                { "rpLightProjectionQ",		"highp" },
                { "rpLightFalloffS",		"mediump" },
                { "rpBumpMatrixS",			"mediump" },
                { "rpBumpMatrixT",			"mediump" },
                { "rpDiffuseMatrixS",		"mediump" },
                { "rpDiffuseMatrixT",		"mediump" },
                { "rpSpecularMatrixS",		"mediump" },
                { "rpSpecularMatrixT",		"mediump" },
                { "rpVertexColorModulate",	"mediump" },
                { "rpVertexColorAdd",		"mediump" },
                { "rpColor",				"mediump" },
                { "rpViewOrigin",			"highp" },
                { "rpGlobalEyePos",			"highp" },
                { "rpMVPmatrixX",			"highp" },
                { "rpMVPmatrixY",			"highp" },
                { "rpMVPmatrixZ",			"highp" },
                { "rpMVPmatrixW",			"highp" },
                { "rpModelMatrixX",			"highp" },
                { "rpModelMatrixY",			"highp" },
                { "rpModelMatrixZ",			"highp" },
                { "rpModelMatrixW",			"highp" },
                { "rpProjectionMatrixX",	"highp" },
                { "rpProjectionMatrixY",	"highp" },
                { "rpProjectionMatrixZ",	"highp" },
                { "rpProjectionMatrixW",	"highp" },
                { "rpModelViewMatrixX",		"highp" },
                { "rpModelViewMatrixY",		"highp" },
                { "rpModelViewMatrixZ",		"highp" },
                { "rpModelViewMatrixW",		"highp" },
                { "rpTextureMatrixS",		"mediump" },
                { "rpTextureMatrixT",		"mediump" },
                { "rpTexGen0S",				"highp" },
                { "rpTexGen0T",				"highp" },
                { "rpTexGen0Q",				"highp" },
                { "rpTexGen0Enabled",		"mediump" },
                { "rpTexGen1S",				"highp" },
                { "rpTexGen1T",				"highp" },
                { "rpTexGen1Q",				"highp" },
                { "rpTexGen1Enabled",		"mediump" },
                { "rpWobbleSkyX",			"mediump" },
                { "rpWobbleSkyY",			"mediump" },
                { "rpWobbleSkyZ",			"mediump" },
                { "rpOverbright",			"mediump" },
                { "rpEnableSkinning",		"mediump" },
                { "rpAlphaTest",			"mediump" },
                { "rpAmbientColor",			"mediump" },
                { "rpGlobalLightOrigin",	"highp" },
                { "rpJitterTexScale",		"mediump" },
                { "rpJitterTexOffset",		"mediump" },
                { "rpCascadeDistances",		"highp" },
                { "rpShadowMatrices",		"highp" },
                { "rpShadowMatrix0Y",		"highp" },
                { "rpShadowMatrix0Z",		"highp" },
                { "rpShadowMatrix0W",		"highp" },
                { "rpShadowMatrix1X",		"highp" },
                { "rpShadowMatrix1Y",		"highp" },
                { "rpShadowMatrix1Z",		"highp" },
                { "rpShadowMatrix1W",		"highp" },
                { "rpShadowMatrix2X",		"highp" },
                { "rpShadowMatrix2Y",		"highp" },
                { "rpShadowMatrix2Z",		"highp" },
                { "rpShadowMatrix2W",		"highp" },
                { "rpShadowMatrix3X",		"highp" },
                { "rpShadowMatrix3Y",		"highp" },
                { "rpShadowMatrix3Z",		"highp" },
                { "rpShadowMatrix3W",		"highp" },
                { "rpShadowMatrix4X",		"highp" },
                { "rpShadowMatrix4Y",		"highp" },
                { "rpShadowMatrix4Z",		"highp" },
                { "rpShadowMatrix4W",		"highp" },
                { "rpShadowMatrix5X",		"highp" },
                { "rpShadowMatrix5Y",		"highp" },
                { "rpShadowMatrix5Z",		"highp" },
                { "rpShadowMatrix5W",		"highp" },
                { "rpUser0",				"mediump" },
                { "rpUser1",				"mediump" },
                { "rpUser2",				"mediump" },
                { "rpUser3",				"mediump" },
...
static const char* GetPrecisionForGLSLVar( const char* glslName )
{
    for( int i = 0; glslPrecisionMap[i].name != NULL; i++ )
    {
        if( idStr::Cmp( glslPrecisionMap[i].name, glslName ) == 0 )
            return glslPrecisionMap[i].precision;
    }
    return "";
}

static const char* GetPrecisionForSamplerType( const char* samplerType )
{
    for( int i = 0; samplerPrecisionMap[i].name != NULL; i++ )
    {
        if( idStr::Cmp( samplerPrecisionMap[i].name, samplerType ) == 0 )
            return samplerPrecisionMap[i].precision;
    }
    return "";
}

static const char* GetPrecisionForUniform( const char* name )
{
    for( int i = 0; uniformPrecisions[i].name != NULL; i++ )
    {
        if( idStr::Cmp( uniformPrecisions[i].name, name ) == 0 )
            return uniformPrecisions[i].precision;
    }
    return "highp";
}

static idStr ArmOptimizeShaderSafe( const idStr& glsl )
{
    idStr out;
    idLexer lex( LEXFL_NOFATALERRORS );
    lex.LoadMemory( glsl.c_str(), glsl.Length(), "arm_opt_safe" );

    idToken token;
    while( lex.ReadToken( &token ) )
    {

        for( int l = 0; l < token.linesCrossed; l++ )
            out += '\n';
        ...
        if( token == "if" )
        {
            ...
            while( lex.ReadToken( &token ) )
            {
                ...
                cond += token;
                if( token.WhiteSpaceBeforeToken() ) cond += ' ';
            }
            ...
            while( lex.ReadToken( &token ) )
            {
                ...
                trueBlock += token;
                if( token.WhiteSpaceBeforeToken() ) trueBlock += ' ';
            }

            bool hasElse = false;
            idStr falseBlock;
            if( lex.PeekTokenString( "else" ) )
            {
                lex.ReadToken( &token );
                hasElse = true;
                if( lex.CheckTokenString( "{" ) )
                {
                    ...
                    while( lex.ReadToken( &token ) )
                    {
                        ...
                        falseBlock += token;
                        if( token.WhiteSpaceBeforeToken() ) falseBlock += ' ';
                    }
                }
                else
                {
                    ...
                    idStr elseBody;
                    while( lex.ReadToken( &token ) && token != ";" )
                    {
                        elseBody += token;
                        if( token.WhiteSpaceBeforeToken() ) elseBody += ' ';
                    }
                    out += "if (" + cond + ") {\n" + trueBlock + "\n} else\n" + elseBody + ";";
                    continue;
                }
            ...
            if( hasElse && trueBlock.Length() > 0 && falseBlock.Length() > 0 )
            {
                idLexer tlex( LEXFL_NOFATALERRORS );
                tlex.LoadMemory( trueBlock.c_str(), trueBlock.Length(), "true" );
                idStr varA, exprA;
                if( tlex.ReadToken( &token ) )
                {
                    varA = token;
                    if( tlex.CheckTokenString( "=" ) )
                    {
                        while( tlex.ReadToken( &token ) && token != ";" )
                            exprA += token + " ";
                        exprA.StripTrailing( ' ' );
                    }
                }

                idLexer flex( LEXFL_NOFATALERRORS );
                flex.LoadMemory( falseBlock.c_str(), falseBlock.Length(), "false" );
                idStr varB, exprB;
                if( flex.ReadToken( &token ) )
                {
                    varB = token;
                    if( flex.CheckTokenString( "=" ) )
                    {
                        while( flex.ReadToken( &token ) && token != ";" )
                            exprB += token + " ";
                        exprB.StripTrailing( ' ' );
                    }
                }

                if( varA == varB && exprA.Length() && exprB.Length() )
                {
                    out += va( "%s = mix( %s, %s, float( %s ) );\n", varA.c_str(), exprB.c_str(), exprA.c_str(), cond.c_str() );
                    optimized = true;
                }
            }
        ...
        if( token.WhiteSpaceBeforeToken() && out.Length() && out[out.Length()-1] != '\n' )
            out += ' ';
        out += token;
    }
...
idStr idRenderProgManager::ConvertCG2GLSL( const idStr& in, const char* name, rpStage_t stage, idStr& layout, bool vkGLSL, bool hasGPUSkinning )
{
    ...
    while( src.ReadToken( &token ) )
    {
        ...
        if( vkGLSL )
        {
                     ...
                     src.PeekTokenString( "sampler2DArray" ) ) )
            {
                ...
                src.ReadToken( &token );
                idStr samplerType = token;

                if( samplerType == "samplerCUBE" )
                    samplerType = "samplerCube";


                const char* prec = GetPrecisionForSamplerType( samplerType );
                if( prec[0] )
                {
                    samplerEntry += prec;
                    samplerEntry += " ";
                }
                samplerEntry += samplerType;
                samplerEntry += " ";
                ...
                samplerList.Append( samplerEntry );
        ...
        if( token == "struct" )
        {
            if( src.CheckTokenString( "VS_IN" ) )
            {
                ...
                for( int i = 0; i < varsIn.Num(); i++ )
                {
                    ...
                    {
                        const char* prec = GetPrecisionForGLSLVar( varsIn[i].nameGLSL );
                        idStr precStr = prec[0] ? idStr(prec) + " " : idStr("");


                        if( vkGLSL )
                        {
                            program += va( "layout( location = %i ) in %s%s %s;\n", i, precStr.c_str(), varsIn[i].type.c_str(), varsIn[i].nameGLSL.c_str() );
                        }
                        else
                        {
                            program += "in " + precStr + varsIn[i].type + " " + varsIn[i].nameGLSL + ";\n";
                        }
                    }
                }
                continue;
            ...
            else if( src.CheckTokenString( "VS_OUT" ) )
            {
                ...
                for( int i = 0; i < varsOut.Num(); i++ )
                {
                    ...
                    {
                        const char* prec = GetPrecisionForGLSLVar( varsOut[i].nameGLSL );
                        idStr precStr = prec[0] ? idStr(prec) + " " : idStr("");

                        if( vkGLSL )
                        {
                            program += va( "layout( location = %i ) out %s%s %s;\n", numDeclareOut, precStr.c_str(), varsOut[i].type.c_str(), varsOut[i].nameGLSL.c_str() );
                        }
                        else
                        {
                            program += "out " + precStr + varsOut[i].type + " " + varsOut[i].nameGLSL + ";\n";
                        }
                        numDeclareOut++;
                    }
                }
            ...
            else if( src.CheckTokenString( "PS_IN" ) )
            {
                ...
                for( int i = 0; i < varsIn.Num(); i++ )
                {
                    if( varsIn[i].declareInOut )
                    {
                        ...
                        if( vkGLSL )
                        {
                            program += va( "layout( location = %i ) in %s%s %s;\n", numDeclareOut, precStr.c_str(), varsIn[i].type.c_str(), varsIn[i].nameGLSL.c_str() );
                        }
                        else
                        {
                            program += "in " + precStr + varsIn[i].type + " " + varsIn[i].nameGLSL + ";\n";
            ...
            else if( src.CheckTokenString( "PS_OUT" ) )
            {
                ...
                for( int i = 0; i < varsOut.Num(); i++ )
                {
                    if( varsOut[i].declareInOut )
                    {
                        ...
                        if( vkGLSL )
                        {
                            program += va( "layout( location = %i ) out %s%s %s;\n", i, precStr.c_str(), varsOut[i].type.c_str(), varsOut[i].nameGLSL.c_str() );
                        }
                        else
                        {
                            program += "out " + precStr + varsOut[i].type + " " + varsOut[i].nameGLSL + ";\n";
            ...
            if( token == uniformList[i] )
            {
                ...
                if( idStr::Cmp( uniformList[i].c_str(), "rpShadowMatrices" ) == 0 )
                {
                    ...
                    else
                    {
                        ...
                        program += va( "%s[%d + ", uniformArrayName, i );
                    }
    ...
    if( uniformList.Num() > 0 )
    {
        if( vkGLSL )
        {
            ...
            for( int i = 0; i < uniformList.Num(); i++ )
            {
                const char* prec = GetPrecisionForUniform( uniformList[i] );
                out += va( "\t%s vec4 %s", prec, uniformList[i].c_str() );
